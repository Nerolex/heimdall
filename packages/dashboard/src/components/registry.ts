...
import { ConcertsUpcomingView } from './views/concerts/ConcertsUpcomingView';
import { ConcertsWeekendView } from './views/concerts/ConcertsWeekendView';
...
registerComponent('concerts-upcoming', ConcertsUpcomingView);
registerComponent('concerts-weekend', ConcertsWeekendView);
